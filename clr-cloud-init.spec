...
Version  : 4
Release  : 5
URL      : https://github.com/clearlinux/clr-cloud-init/releases/download/v4/clr-cloud-init-4.tar.xz
Source0  : https://github.com/clearlinux/clr-cloud-init/releases/download/v4/clr-cloud-init-4.tar.xz
