...
Version  : 5
Release  : 6
URL      : https://github.com/clearlinux/clr-cloud-init/releases/download/v5/clr-cloud-init-5.tar.xz
Source0  : https://github.com/clearlinux/clr-cloud-init/releases/download/v5/clr-cloud-init-5.tar.xz
