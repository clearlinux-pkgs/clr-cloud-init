...
Version  : 10
Release  : 11
URL      : https://github.com/clearlinux/clr-cloud-init/releases/download/v10/clr-cloud-init-10.tar.xz
Source0  : https://github.com/clearlinux/clr-cloud-init/releases/download/v10/clr-cloud-init-10.tar.xz
...
%files config
%defattr(-,root,root,-)
/usr/lib/systemd/system/cloud-init-firstboot.service
/usr/lib/systemd/system/cloud-init.service
/usr/lib/systemd/system/multi-user.target.wants/cloud-init-firstboot.service
