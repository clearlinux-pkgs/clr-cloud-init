...
Version  : 8
Release  : 9
URL      : https://github.com/clearlinux/clr-cloud-init/releases/download/v8/clr-cloud-init-8.tar.xz
Source0  : https://github.com/clearlinux/clr-cloud-init/releases/download/v8/clr-cloud-init-8.tar.xz
